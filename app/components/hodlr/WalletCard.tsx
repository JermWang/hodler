    ...
    <div className="rounded-xl border border-white/[0.06] bg-[#0b0c0e] p-5">
      {!connected ? (
        <div className="flex flex-col items-center gap-4 py-4">
          <div className="flex h-11 w-11 items-center justify-center rounded-xl bg-[#38BDF8]/[0.08] border border-[#38BDF8]/20">
          ...
          <WalletMultiButton className="!bg-[#38BDF8] hover:!bg-[#c8f560] !text-black !font-bold !text-xs !h-8 !rounded-lg !px-4" />
        </div>
      ) : (
        <div className="flex flex-col gap-4">
          <div className="flex items-center gap-3">
            <div className="flex h-8 w-8 items-center justify-center rounded-xl bg-[#38BDF8]/[0.08] border border-[#38BDF8]/20">
          ...
          <div className="p-4 rounded-xl bg-[#38BDF8]/[0.05] border border-[#38BDF8]/15">
            <div className="flex items-center justify-between">
              <div>
                <div className="text-[10px] font-black text-[#38BDF8]/40 uppercase tracking-widest mb-1.5">Claimable</div>
                <div className="flex items-baseline gap-1.5">
                  <span className="text-2xl font-black font-mono text-[#38BDF8] tabular-nums">{lamportsToSol(claimableLamports)}</span>
                  <span className="text-xs font-bold text-[#38BDF8]/50">SOL</span>
                </div>
              </div>
              {eligible && (
          ...
          {hasClaimable ? (
            <button
              onClick={onClaim}
              disabled={claiming}
              className="w-full py-3 rounded-xl text-sm font-black bg-[#38BDF8] text-black hover:bg-[#c8f560] transition-all shadow-[0_0_20px_rgba(56, 189, 248,0.2)] disabled:opacity-50"
            >
